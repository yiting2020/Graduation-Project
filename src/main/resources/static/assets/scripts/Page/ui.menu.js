; (function (mp) {
    ...
    var Menu = ui.define("ctrls.Menu", {
        ...
        setMenuList: function (menus) {
            ...
            for (i = 0, len = menus.length; i < len; i++) {
                ...
                htmlBuilder.push("<imgs src='", (m.icon ? this.option.urlPrefix + m.icon : ""), "' />");
                htmlBuilder.push("</i>");
                ...
                htmlBuilder.push("</dt>");
                if ($.isArray(m.children) && m.children.length > 0) {
    ...
    mp._initElements = function () {
        ...
        if (this.noMenu) {
            ...
            menuOption.menuButton.off("click").click(function() {
                location.href = masterpage.ctxPath + "/home/index";
            });
        } else {
